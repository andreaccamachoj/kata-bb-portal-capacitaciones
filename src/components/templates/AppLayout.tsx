...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  console.log('has role', hasRole(['STUDENT']));
  ...
  const navItems = [
    { to: '/', icon: Home, label: 'Dashboard', roles: ['STUDENT', 'INSTRUCTOR', 'ADMIN'] },
    { to: '/catalog', icon: BookOpen, label: 'Catálogo', roles: ['STUDENT', 'INSTRUCTOR', 'ADMIN'] },
    { to: '/me/learning', icon: GraduationCap, label: 'Mi Aprendizaje', roles: ['STUDENT', 'INSTRUCTOR', 'ADMIN'] },
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-10 w-10 rounded-full">
                  <Avatar>
                    <AvatarImage src={'https://api.dicebear.com/7.x/avataaars/svg?seed=Carlos'} alt={user?.userName} />
